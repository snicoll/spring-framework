...
public class MappingJackson2MessageConverter implements SmartMessageConverter, BeanClassLoaderAware {
	 ...
	 * @deprecated as of 4.2, use {@link #mapToTextMessage(Object, Session, ObjectWriter)}
	 */
	@Deprecated
	 ...
	 * @throws IOException in case of I/O errors
	 * @see Session#createBytesMessage
	 * @deprecated as of 4.2, use {@link #mapToBytesMessage(Object, Session, ObjectWriter)}
	 */
	@Deprecated
	 ...
	 * @throws JMSException if thrown by JMS methods
	 * @throws IOException in case of I/O errors
	 * @deprecated as of 4.2, use {@link #mapToMessage(Object, Session, ObjectWriter, MessageType)}
	 */
	@Deprecated
