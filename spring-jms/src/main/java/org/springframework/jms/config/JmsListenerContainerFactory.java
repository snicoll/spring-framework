...
public interface JmsListenerContainerFactory {
	...
	/**
	 * Create an initialized {@link MessageListenerContainer} for the given
	 * {@linkplain JmsListenerEndpoint endpoint}.
	 * <p>The container should be initialized and ready for use at this point
	 * in a similar fashion as if it was created manually once the context
	 * has started.
