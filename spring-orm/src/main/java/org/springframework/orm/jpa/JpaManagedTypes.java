...
/**
 * Provide the list of managed JPA types that an entity manager should consider.
 *
 * @author Stephane Nicoll
 * @since 6.0
 */
public interface JpaManagedTypes {

	/**
	 * Return class names the persistence provider must add to its set of managed
	 * classes.
	...
	/**
	 * Return the persistence unit root url or {@code null} if it could
	 * not be determined.
