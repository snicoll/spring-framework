 ...
 */
public class IndexBeanDefinitionScanner extends SpringComponentsIndexCandidateComponentProvider {
	...
	public IndexBeanDefinitionScanner(BeanDefinitionRegistry registry) {
		this(registry, null); // TODO
	}

	public IndexBeanDefinitionScanner(BeanDefinitionRegistry registry, SpringComponentsIndex index) {
		super(index);
