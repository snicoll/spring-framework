...
public abstract class ConfigurationClassUtils {
	...
	/**
	 * Register the necessary {@linkplain Callback callbacks} for the specified
	 * configuration class.
	 * @param configurationClass the configuration class to enhance
	 */
	public static void registerEnhancerCallbacks(Class<?> configurationClass) {
