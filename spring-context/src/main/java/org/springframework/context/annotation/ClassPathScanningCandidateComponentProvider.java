 ...
 * include filters. Only {@link AnnotationTypeFilter} include filters on an
 * annotation that is meta-annotated with {@link Indexed} are supported: if any other
 * include filter is specified, the index is ignored and classpath scanning is used
 * instead.
 *
...
public class ClassPathScanningCandidateComponentProvider implements EnvironmentCapable, ResourceLoaderAware {
	 ...
	 * @return {@code true} if the index is available the configuration of this instance
	 * is supported by it, {@code false otherwise}.
	 */
