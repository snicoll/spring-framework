...
public class CacheSyncFailureTests {
	...
	public void conditionalSync() {
		...
		thrown.expectMessage("@Cacheable(sync = true) does not support condition attribute");
		this.simpleService.conditionalSync("key");
	}
	...
	static class SimpleService {
		...
		@Cacheable(cacheNames = "testCache", sync = true, condition = "#arg1 == null")
		public Object conditionalSync(Object key) {
