...
public class AnnotationCacheOperationSourceTests {
	...
	@Test
	public void severalCacheConfigNotSupported() {
		thrown.expect(IllegalStateException.class);
		getOps(MultipleCacheConfig.class, "willNotWork");
	}
	...
	@CacheConfig(value = "classCacheName",
	...
	@CacheConfigFoo
	@CacheConfig("myCache") // multiple sources, not supported
