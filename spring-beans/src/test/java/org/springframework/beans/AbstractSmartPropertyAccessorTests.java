...
/**
 * Shared tests for smart property accessors.
 *
 * @author Rod Johnson
 ...
 */
public abstract class AbstractSmartPropertyAccessorTests<A extends AbstractSmartPropertyAccessor<?>> {

	@Rule
	public final ExpectedException thrown = ExpectedException.none();


	protected abstract A createAccessor(Object target);
	...
	public void isReadableProperty() {
		A accessor = createAccessor(new Simple("John", 2));
	...
	public void isReadablePropertyNotReadable() {
		A accessor = createAccessor(new NoRead());
	...
	public void isReadableWritableForIndexedProperties() {
		...
		A accessor = createAccessor(target);
	...
	public void setNestedPropertyPolymorphic() throws Exception {
		...
		A kerryAccessor = createAccessor(kerry);
	...
	public void setIndexedPropertyIgnored() {
		...
		A accessor = createAccessor(new Object());
	...
	public void setPrimitiveArrayPropertyLargeMatching() {
		...
		Assume.notLogging(LogFactory.getLog(AbstractSmartPropertyAccessorTests.class));
