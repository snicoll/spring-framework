 ...
 */
public abstract class AbstractSmartPropertyAccessor extends AbstractPropertyAccessor {
	 ...
	 */
	private Map<String, AbstractSmartPropertyAccessor> nestedPropertyAccessors;
	 ...
	 */
	protected AbstractSmartPropertyAccessor() {
		this(true);
	}
	 ...
	 * @see #setWrappedInstance
	 */
	protected AbstractSmartPropertyAccessor(boolean registerDefaultEditors) {
	 ...
	 */
	protected AbstractSmartPropertyAccessor(Object object) {
		registerDefaultEditors();
	 ...
	 */
	protected AbstractSmartPropertyAccessor(Class<?> clazz) {
		registerDefaultEditors();
	 ...
	 */
	protected AbstractSmartPropertyAccessor(Object object, String nestedPath, Object rootObject) {
		registerDefaultEditors();
	 ...
	 */
	protected AbstractSmartPropertyAccessor(Object object, String nestedPath, AbstractSmartPropertyAccessor parent) {
	...
	public void setPropertyValue(String propertyName, Object value) throws BeansException {
		AbstractSmartPropertyAccessor nestedPa;
		try {
	...
	public TypeDescriptor getPropertyTypeDescriptor(String propertyName) throws BeansException {
		try {
			AbstractSmartPropertyAccessor nestedPa = getPropertyAccessorForPropertyPath(propertyName);
	 ...
	 */
	protected abstract AbstractSmartPropertyAccessor newNestedPropertyAccessor(Object object, String nestedPath);
	 ...
	 */
	private String getFinalPath(AbstractSmartPropertyAccessor pa, String nestedPath) {
		if (pa == this) {
			return nestedPath;
		}
	...
	protected AbstractSmartPropertyAccessor getPropertyAccessorForPropertyPath(String propertyPath) {
	 ...
	 */
	private AbstractSmartPropertyAccessor getNestedPropertyAccessor(String nestedProperty) {
		if (this.nestedPropertyAccessors == null) {
			this.nestedPropertyAccessors = new HashMap<String, AbstractSmartPropertyAccessor>();
		}
		...
		AbstractSmartPropertyAccessor nestedPa = this.nestedPropertyAccessors.get(canonicalName);
