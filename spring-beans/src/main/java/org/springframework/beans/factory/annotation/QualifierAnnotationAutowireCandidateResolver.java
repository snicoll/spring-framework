...
public class QualifierAnnotationAutowireCandidateResolver extends GenericTypeAwareAutowireCandidateResolver {
	...
	protected boolean checkQualifier(
		...
		if (qualifier == null) {
			// First, check annotation on qualifier provider, if any
			Annotation targetAnnotation = getQualifierProviderAnnotation(bd, type);
	...
	protected Annotation getQualifierProviderAnnotation(RootBeanDefinition bd, Class<? extends Annotation> type) {
		AnnotatedElement qualifierProvider = bd.getQualifierProvider();
		return (qualifierProvider != null ? AnnotationUtils.getAnnotation(qualifierProvider, type) : null);
	}
