...
public final class BeanInstanceSupplier<T> extends AutowiredElementResolver implements InstanceSupplier<T> {
	...
	public T get(RegisteredBean registeredBean) throws Exception {
		...
		if (this.generator != null) {
			return invokeBeanSupplier(registeredBean, executable, () ->
	...
	private T invokeBeanSupplier(RegisteredBean registeredBean, Executable executable, ThrowingSupplier<T> beanSupplier) {
		// FIXME: the target class of the executable can be a proxy
