...
public class JCacheAspectSupport implements InitializingBean {
	...
	protected Object execute(Invoker invoker, Object target, Method method, Object[] args) throws Throwable {
	...
	@SuppressWarnings("unchecked")
	// Awful, need to find a better way to call the proper interceptor
	private Object execute(CacheOperationInvocationContext<?> context, Invoker invoker) throws Throwable {
