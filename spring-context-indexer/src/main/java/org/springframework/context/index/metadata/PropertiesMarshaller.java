...
/**
 * Marshaller to write {@link SpringComponentsMetadata} as properties.
 *
...
public class PropertiesMarshaller {
	...
	public void write(SpringComponentsMetadata metadata, OutputStream out)
			throws IOException {
	...
	public SpringComponentsMetadata read(InputStream in) throws IOException {
		SpringComponentsMetadata result = new SpringComponentsMetadata();
		Properties props = new Properties();
		props.load(in);
