...
/**
 * Store {@link SpringComponentsMetadata} on the filesystem.
 *
...
class MetadataStore {
	...
	public SpringComponentsMetadata readMetadata() {
		try {
	...
	public void writeMetadata(SpringComponentsMetadata metadata) throws IOException {
	...
	private SpringComponentsMetadata readMetadata(InputStream in) throws IOException {
		try {
