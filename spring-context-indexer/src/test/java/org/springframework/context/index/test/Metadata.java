...
/**
 * Hamcrest {@link org.hamcrest.Matcher Matcher} to help test {@link SpringComponentsMetadata}.
 *
...
public class Metadata {
	...
	private static class ItemMetadataMatcher extends BaseMatcher<SpringComponentsMetadata> {
		...
		public boolean matches(Object value) {
			if (!(value instanceof SpringComponentsMetadata)) {
				return false;
			}
			ItemMetadata itemMetadata = getFirstItemWithType((SpringComponentsMetadata) value, this.type);
		...
		private ItemMetadata getFirstItemWithType(SpringComponentsMetadata metadata, String type) {
