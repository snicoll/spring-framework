...
/**
 * Alternative method reference implementation.
 *
...
public interface MethodReference2 {
	...
	/**
	 * Return this method reference as a {@link CodeBlock} to be added in the
	 * specified {@code declaringClass}. The specified {@link ArgumentCodeGenerator}
	 * can be used to resolve method arguments, if any.
	 * @param declaringClass the class in which the method invocation is added
	 * @return a code block for the method reference.
	 */
	CodeBlock toInvokeCodeBlock(ClassName declaringClass, ArgumentCodeGenerator argumentCodeGenerator);
