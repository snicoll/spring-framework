 ...
 * @since 6.0
 */
public record PropertySourceDescriptor(List<String> locations, @Nullable String name,
		@Nullable Class<? extends PropertySourceFactory> propertySourceFactory,
	...
	public PropertySourceDescriptor(String... locations) {
		this(Arrays.asList(locations), null, null, null, false);
	}
