...
public final class PlaceholderResolutionException extends RuntimeException {
	 ...
	 */
	public PlaceholderResolutionException(String reason, String placeholder, @Nullable String value) {
	 ...
	 */
	public PlaceholderResolutionException withValue(String value) {
